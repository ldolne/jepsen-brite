...
class CategoryManager extends Manager
{
    ...
    {
        $bdd = $this->dbConnect();
        $req = $bdd->query('SELECT e.id, e.title, DATE_FORMAT(e.event_date, \'%d/%m/%Y\') AS event_date_formatted, DATE_FORMAT(e.event_hour, \'%H:%i\') AS event_hour_formatted, c.category, s.subcategory
            FROM events AS e
