...
class EventController
{
    ...
    public function createNewEvent()
    {
        ...
        } elseif(isset($_FILES['image']) && !empty($_FILES['image']['name']) && !empty($_POST['url'])){
            $message = 'You cannot upload both an image an a video.';
            $this->showEventCreationPage(showInfoMessage($message, false));
