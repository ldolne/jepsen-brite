    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="search">
                <nav>
                    <ul>
                        <li> <a href="./index.php?action=allcategorycontroller"> <button class="btn btn-primary">All</button></a></li>

                        <li><a href="./index.php?action=onecategorycontroller&amp;category_id=1"><button class="btn btn-primary">Concert</button></a>
                            <ul>
                                ...
                                <a href="./index.php?action=subcategorycontroller&amp;subcategory_id=21"><button class="btn btn-success">EDM</button></a>
                            </ul>
                        </li>

                        <li><a href="./index.php?action=onecategorycontroller&amp;category_id=2"><button class="btn btn-primary">Exhibition</button></a>
                            <ul>
                                ...
                                <a href="./index.php?action=subcategorycontroller&amp;subcategory_id=51"><button class="btn btn-success">Historical</button></a>
                            </ul>
                        </li>

                        <li><a href="./index.php?action=onecategorycontroller&amp;category_id=3"><button class="btn btn-primary">Conference</button></a>
                            <ul>
                                ...
                                <a href="./index.php?action=subcategorycontroller&amp;subcategory_id=81"><button class="btn btn-success">Educational</button></a>
                            </ul>
                        </li>


                        <li><a href="./index.php?action=onecategorycontroller&amp;category_id=4"><button class="btn btn-primary">Hackathon</button></a>
                            <ul>
                                ...
                                <a href="./index.php?action=subcategorycontroller&amp;subcategory_id=111"><button class="btn btn-success">Social</button></a>
                            </ul>
                        </li>

                        <li><a href="./index.php?action=onecategorycontroller&amp;category_id=5"><button class="btn btn-primary">Game Jam</button></a>
                            <ul>
                                ...
                                <a href="./index.php?action=subcategorycontroller&amp;subcategory_id=141"><button class="btn btn-success">MOBA</button></a>
                            </ul>
                        </li>
                    </ul>
                </nav>
